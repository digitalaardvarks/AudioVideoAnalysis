...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 421.0, 525.0, 98.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 501.0, 98.0, 22.0 ],
					"text" : "gl_color 0 1 1 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 99.0, 172.0, 172.5, 22.0 ],
					"text" : "router 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 816.0, 568.0, 227.0, 77.0 ],
					"text" : "jit.gl.mesh AudioVideoAnalysis @layer 2 @draw_mode line_loop @color 1 1 1 1 @transform_reset 2 @automatic 0 @line_width 0.64 @blend_mode 1 1 @blend_enable 0 @depth_enable 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 588.0, 568.0, 221.0, 77.0 ],
					"text" : "jit.gl.mesh AudioVideoAnalysis @layer 2 @draw_mode line_loop @color 1 1 1 1 @transform_reset 2 @automatic 0 @line_width 0.64 @blend_mode 1 1 @blend_enable 0 @depth_enable 0"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "jit.gl.text3d AudioVideoAnalysis @layer 2 @color 1 1 1 1 @fontname Arial @automatic 0 @enable 1 @transform_reset 2 @scale 0.029 0.1 1 @gl_color 1 1 1 1 @blend_mode 1 1 @blend_enable 0 @depth_enable 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 259.149999999999977, 266.608431318297335, 109.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 307.800000000000011, 200.0, 96.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 271.5, 52.0, 96.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 278.5, 77.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.5, 401.5, 23.0, 20.0 ],
					"text" : "y"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 268.125, 385.0, 147.0, 89.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "pak params 60. 0 1. 6 44100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 99.0, 376.0, 162.5, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "AVA-js-analysisMarkers.js",
						"parameter_enable" : 0
					}
,
					"text" : "js AVA-js-analysisMarkers.js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 648.0, 518.0, 161.0, 36.0 ],
					"text" : "jit.gen @gen AVA-snorm-half"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 823.0, 651.0, 43.0, 34.0 ],
					"text" : "y axis grid"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 588.0, 651.0, 43.0, 34.0 ],
					"text" : "x axis grid"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 648.0, 415.0, 161.0, 22.0 ],
